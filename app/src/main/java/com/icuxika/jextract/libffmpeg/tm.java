...
public class tm {
    ...
    static final StructLayout $struct$LAYOUT = MemoryLayout.structLayout(
        Constants$root.C_LONG$LAYOUT.withName("tm_sec"),
        Constants$root.C_LONG$LAYOUT.withName("tm_min"),
        Constants$root.C_LONG$LAYOUT.withName("tm_hour"),
        Constants$root.C_LONG$LAYOUT.withName("tm_mday"),
        Constants$root.C_LONG$LAYOUT.withName("tm_mon"),
        Constants$root.C_LONG$LAYOUT.withName("tm_year"),
        Constants$root.C_LONG$LAYOUT.withName("tm_wday"),
        Constants$root.C_LONG$LAYOUT.withName("tm_yday"),
        Constants$root.C_LONG$LAYOUT.withName("tm_isdst")
    ).withName("tm");
