...
final class constants$0 {
    ...
    static final FunctionDescriptor av_get_sample_fmt_name$FUNC = FunctionDescriptor.of(Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_LONG$LAYOUT
    );
    static final MethodHandle av_get_sample_fmt_name$MH = RuntimeHelper.downcallHandle(
        "av_get_sample_fmt_name",
        constants$0.av_get_sample_fmt_name$FUNC
    );
}
